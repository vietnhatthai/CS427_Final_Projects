...
public class MenuController : MonoBehaviour
{
    ...
    [SerializeField] private float defaultSen = 5;
    ...
    [SerializeField] public TMP_Dropdown resolutionDropdown = null;
    ...
    public void GraphicsApply()
    {
        ...
        // post processing to change brightness
    ...
    public void ResetButtion(string MenuType)
    {
        if (MenuType == "Audio")
        {
        ...
        {
            mainControllerSen = Mathf.RoundToInt(defaultSen);
