...
{
    [CustomEditor(typeof(DefenseLookAtAction), true)]
    public class DefenseLookAtActionEditor : MovementActionEditor
    {
        DefenseLookAtAction m_LookAtAction;
        ...
        protected override void OnEnable()
        {
            ...
            m_LookAtAction = (DefenseLookAtAction)m_Action;
